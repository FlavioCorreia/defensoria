...
import 'package:defensoria/atraso_pensao_3.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class Atraso_Pensao_2  extends StatefulWidget {
  @override
  _Atraso_Pensao_2State createState() => _Atraso_Pensao_2State();
}

class _Atraso_Pensao_2State extends State<Atraso_Pensao_2 > {
                  ...
                  onPressed: () {
                      ...
                      if(_cCPFMae.text.length == 14){//CPF 14 DIGITOS+PNTC
                          ...
                          if(fHelper.validaCPF(_cCPFMae.text)){//SE FOR VALIDO, AVANCE
                              ...
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => Atraso_Pensao_3())
                              );
                          }else{
                              fHelper.buildShowDialog(context, "PREENCHIMENTO DE CAMPOS", "OPS... parece que algum campo não foi preenchido corretamente \n(CPF)");
                              setState(() { _valCPFMae = false; });
